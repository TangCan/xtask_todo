...
- [x] 7.1 Add global --json option to todo subcommands; output unified JSON structure (US-A1).
- [x] 7.2 Use exit codes 0/1/2/3 for success, general, parameter, data errors (US-A2).
- [x] 7.3 Add todo init-ai [--for tool] [--output dir]; generate skill files (US-A3).
- [x] 7.4 Add --dry-run for add/update/complete/delete; no persistence when set (US-A4).

## 8. Validation and docs
- [x] 8.1 Add or extend unit and integration tests for new behavior; ensure pre-commit and CI pass.
- [x] 8.2 Update docs/design.md, docs/tasks.md, docs/test-cases.md, docs/acceptance.md to reflect implemented features.
